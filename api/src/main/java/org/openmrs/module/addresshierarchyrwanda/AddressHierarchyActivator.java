 ...
 */
public class AddressHierarchyActivator extends BaseModuleActivator {
    ...
    public void started() {
        ...
        Context.getService(HtmlFormEntryService.class).addHandler("addressHierarchyRwanda", new AddressHierarchyTagHandler());
    }
