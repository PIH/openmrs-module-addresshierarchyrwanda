...
<openmrs:require privilege="Manage Hierarchy" otherwise="/login.htm"
	redirect="/module/addresshierarchy/addresshierarchyTree.htm" />
<%@ include file="/WEB-INF/template/header.jsp"%>
<openmrs:htmlInclude file="/dwr/interface/AddressHierarchy.js" />
<openmrs:htmlInclude
	file="/moduleResources/addresshierarchy/jquery-latest.pack.js" />
<openmrs:htmlInclude
	file="/moduleResources/addresshierarchy/thickbox.js" />
<openmrs:htmlInclude
	file="/moduleResources/addresshierarchy/loadingAnimation.gif" />
<openmrs:htmlInclude
	file="/moduleResources/addresshierarchy/thickbox.css" />
...
<body>
<input type="submit" value="Reload Tree"
	onclick="window.location.reload()" />
<br>
<br>
<div id="myWidgetContainer"><span id="treePlaceHolder"
	style="background-color: #F00; color: #FFF;"> Loading... </span></div>

<a href="#TB_inline?height=500&width=500&inlineId=addFormField"
	title="Add Locations" class="thickbox" id="linkit"></a>
<div class="cusform" id="addFormField">
<table>
	<tr>
		<th>Address Type</th>
		<td><select name="addaddresstype" id="addaddresstype"
			onchange='document.getElementById("ind").value = this.value;'>
			<option>Select one</option>
		</select> <label id="desc"></label></td>
	</tr>
	<tr>
		<th>Enter the Locations</th>
		<td><textarea name="addText" id="addText" rows="25" cols="40"
			onblur='document.getElementById("txt").value = this.value;'></textarea>
		</td>
	</tr>
	<tr>
		<td><input type="submit" value="Add" onclick='added()' /></td>
	</tr>
</table>
</div>
