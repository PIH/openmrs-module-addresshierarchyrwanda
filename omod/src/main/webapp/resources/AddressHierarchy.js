...
function getPatientAddress(patientId) {
	$j.getJSON(openmrsContextPath  + "/module/addresshierarchyrwanda/patientAddress.form", {
		patientId :patientId
	}, function(data) {
		var count = -1;
...
function changeLocation(parentLocationId, nextElement) {
	...
	$j.getJSON(openmrsContextPath  + "/module/addresshierarchyrwanda/locations.form", {
